...
## data
    parser.add_argument('--CLIP_data', type=str, default=r'deepRAM-master\datasets\CLIP-seq\25_CLIPSEQ_SFRS1_hg19\30000\training_sample_0\sequences.fa.gz',
                        help='path for CLIP-seq data ')
    
    parser.add_argument('--output', type=str, default=r'deepRAM-master\datasets\CLIp-seq out\zip files\25_pre_training_sample_0.gz',
